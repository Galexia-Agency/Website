  ...
  <section class="white">
    <div class="maxWidth">
      ...
      <ul>
        ...
        <li>
          <p>We also use social media buttons on this site that allow you to connect with your social network in various ways. For these to work the following social media sites including; Facebook, Instagram, WhatsApp, LinkedIn, Twitter, will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.</p>
        </li>
      </ul>
      <h3>More Information</h3>
      <p>If you are still looking for more information then you can contact us at: <a href="mailto:info@galexia.agency">info@galexia.agency</a></p>
    </div>
  </section>
</template>
...
export default {
  beforeCreate () {
    ...
    this.$parent.$parent.metaHelper.description = 'Galexia Ltd\'s Cookie Policy'
  }
}
</script>
