...
<template>
  <div>
    <LayoutHeader
      ...
      subtitle="Let us focus on your online presence<br>so you can focus on your <i>business</i>"
    ...
    <section class="white" style="padding-top: 0">
      ...
      <div class="grid grid--column three layout--max-width">
        <div class="card">
