...
export default (context, inject) => {
  ...
  async function screenshotHandler (url, size, aspectratio, zoom) {
    ...
    try {
      ...
      const output = await screenshot(url, format, viewport, dpr)
